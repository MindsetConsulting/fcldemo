		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flexible Column Layout Demo",
									"targetURL": "#fcldemofcldemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fcldemofcldemo-display": {
								"semanticObject": "fcldemofcldemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fcldemo.fcldemo",
									"url": sap.ui.require.toUrl("fcldemo/fcldemo")
								}
							}
						}
					}
